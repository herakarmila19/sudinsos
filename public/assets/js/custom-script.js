(function($) {
	...
	// START GPR WIDGET SHOW HIDE
	// $("#feedback-form").hide();
	// $('.btn-gpr').on('click', function(e){
	// 	$("#feedback-form").toggle();
	// });

	$(function() {
		$(".btn-gpr").on('click', function() {
		...
		$("#feedback-form form").on('submit', function(event) {
			...
			$.ajax({
				...
				success: function() {
					...
					$("#feedback-form").slideToggle("slow").find("textarea").val('');
				}
			});
			event.preventDefault();
		});
	});
	// END GPR WIDGET SHOW HIDE
