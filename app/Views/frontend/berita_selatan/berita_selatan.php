                    ...
                    <div class="content-side col-lg-8 col-md-12 col-sm-12">
                        <div class="content-inner">
                                                ...
                                                <div class="lower-box">
                                                    ...
                                                    <div class="meta-info clearfix">
                                                        <div class="author-info clearfix">
                                                            ...
                                                            <div class="date" style="padding-top: 10px;"><?= namaHari(date('D', strtotime($data['publish_date']))) ?>, <?= date('d', strtotime($data['publish_date'])) ?> <?= namaBulan(date('M', strtotime($data['publish_date']))) ?> <?= date('Y', strtotime($data['publish_date'])) ?></div>
                                                        </div>
                            ...
                            if ($uri->getSegment(2) != 'kategori') {
                                echo $pager->links('berita', 'template_pager');
                            } else {
                                echo $pager;
                            }
                            ?>
