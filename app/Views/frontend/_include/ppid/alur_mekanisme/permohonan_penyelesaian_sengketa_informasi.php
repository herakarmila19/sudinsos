                                ...
                                <section class="history-section" style="padding-bottom: 50px;">
                                    <div class="auto-container">
                                        <div class="sec-title with-separator centered" style="margin-top: -50px;">
                                            <h2>Permohonan Penyelesaian Sengketa Informasi</h2>
                                            <div class="separator"><span class="cir c-1"></span><span class="cir c-2"></span><span class="cir c-3"></span></div>
                                            <div class="lower-text">
                                                Diperbaharui : <?= diperbaharui($penyelesaianPpid['created_date'], $penyelesaianPpid['modified_date']) ?>
                                            </div>
                                        </div>

                                        <?= $penyelesaianPpid['isi_konten'] ?>
                                    </div>
                                </section>
                            </div>
                        </div>
