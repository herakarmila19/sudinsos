                            ...
                            <section class="history-section" style="margin-bottom: -50px">
                                <div class="auto-container">
                                    <div class="sec-title with-separator centered" style="margin-top: -40px;">
                                        <h2>Kecamatan Pancoran</h2>
                                        <div class="separator"><span class="cir c-1"></span><span class="cir c-2"></span><span class="cir c-3"></span></div>
                                        <div class="lower-text">
                                            Diperbaharui : <?= diperbaharui($pancoranDataCreatedDate['created_date'], $pancoranDataModifiedDate['modified_date']) ?> </div>
                                    </div>

                                    <div class="row">

                                        <?php foreach ($pancoranData as $data) : ?>
