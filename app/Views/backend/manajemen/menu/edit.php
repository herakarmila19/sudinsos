...
<div class="content-wrapper">
    ...
    <section class="content">
        <form action="<?= base_url('admin/menu/' . $menuData->id_menu) ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="judul" class="form-control <?= ($validation->hasError('judul')) ? 'is-invalid' : ''; ?>" value="<?= $menuData->judul ?>" autofocus required>
                                        <p class="text-danger">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>URL</label>
                                        <input type="text" name="url" class="form-control <?= ($validation->hasError('url')) ? 'is-invalid' : ''; ?>" value='<?= $menuData->url ?>' required>
                                        <p class="text-danger">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="publish" class="form-control <?= ($validation->hasError('publish')) ? 'is-invalid' : ''; ?>" required>
                                            <option value="<?= $menuData->publish ?>" selected><?= ($menuData->publish == 0 ? 'Draft' : 'Publish') ?></option>
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <a href="<?= base_url('admin/menu/' . $menuData->id_menu) ?>" class="btn btn-secondary mb-3">Batal</a>
