                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="keterangan" class="form-control"
                                        value="<?= $prestasiKerjaData->keterangan ?>" autofocus disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tahun" class="form-control"
                                        value="<?= $prestasiKerjaData->tahun ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="created_date" class="form-control"
                                        value="<?= date('d M Y, H:i', strtotime($prestasiKerjaData->created_date)) ?>"
                                        disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="modified_date" class="form-control"
                                        value="<?= date('d M Y, H:i', strtotime($prestasiKerjaData->modified_date)) ?>"
                                        disabled>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col-12">
                <form action="<?= base_url('admin/prestasi-kerja/' . $prestasiKerjaData->id) ?>" method="post"
                    id="confirm">
                    <a href="<?= base_url('admin/prestasi-kerja') ?>" class="btn btn-secondary mb-3">Kembali</a>

                    <?= csrf_field(); ?>
                    <input type="hidden" name="_method" value="DELETE">
                    <a value="Hapus" class="btn btn-danger float-right swal-confirm">Hapus</a>

                    <a href="<?= base_url('admin/prestasi-kerja/' . $prestasiKerjaData->id . '/edit') ?>">
