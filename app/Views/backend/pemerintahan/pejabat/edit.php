...
<div class="content-wrapper">
    ...
    <section class="content">
        <form action="<?= base_url('admin/pejabat/' . $pejabatData->id) ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Nama</label>
                                        <input type="text" name="nama" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : ''; ?>" value="<?= $pejabatData->nama ?>" autofocus required>
                                        <p class="text-danger">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="jabatan" class="form-control <?= ($validation->hasError('jabatan')) ? 'is-invalid' : ''; ?>" value="<?= $pejabatData->jabatan ?>" placeholder="Contoh: Walikota / Plt. Lurah Ragunan / 1966 - 1968" required>
                                        <p class="text-danger">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control <?= ($validation->hasError('kategori')) ? 'is-invalid' : ''; ?>" name="kategori" required>
                                            <option value="<?= $pejabatData->kategori ?>" selected><?= $pejabatData->kategori ?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="text" name="fotoLama" id="fotoDefault" hidden value="<?= $pejabatData->foto ?>">
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <a href="<?= base_url('admin/pejabat/' . $pejabatData->id) ?>" class="btn btn-secondary mb-3">Batal</a>
