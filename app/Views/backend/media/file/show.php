...
<div class="content-wrapper">
    ...
    <section class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" value="<?= $fileData->title ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="created_date" class="form-control" value="<?= date('d M Y, H:i', strtotime($fileData->created_date)) ?>" disabled>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col-12">
                <form action="<?= base_url('admin/file/' . $fileData->id_files) ?>" method="post" id="confirm">
                    <a href="<?= base_url('admin/file') ?>" class="btn btn-secondary mb-3">Kembali</a>

                    <?= csrf_field(); ?>
                    <input type="hidden" name="_method" value="DELETE">
                    <a value="Hapus" class="btn btn-danger float-right swal-confirm">Hapus</a>

                    <a href="<?= base_url('admin/file/' . $fileData->id_files . '/edit') ?>">
