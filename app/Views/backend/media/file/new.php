...
<div class="content-wrapper">
    ...
    <section class="content">
        <form action="<?= base_url('admin/file') ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" name="source" class="custom-file-input <?= ($validation->hasError('source')) ? 'is-invalid' : ''; ?>" onchange="dokumenPreview()" required>
            ...
            <div class="row">
                <div class="col-12">
                    <a href="<?= base_url('admin/file') ?>" class="btn btn-secondary mb-3">Batal</a>
