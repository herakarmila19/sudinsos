                ...
                new $.fn.dataTable.Buttons(api, {
                    buttons: [{
                        ...
                        action: function(e, dt, node, conf) {
                            window.location.href = '<?= base_url('admin/file/new') ?>';
                        }
                    }, ],
                });
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table id="tabel" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php foreach ($fileData as $no => $data) : ?>
                            <tr>
                                <td><?= $no + 1 ?></td>
                                <td><?= $data->title ?></td>
                                <td><?= $data->type ?></td>
                                <td>
                                    <div class="btn btn-sm btn-info cpy" data-link="<?= base_url('files/' . $data->source) ?>">Copy</div>
                                ...
                                <td><a href="<?= base_url('admin/file/' . $data->id_files) ?>">Detail</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
